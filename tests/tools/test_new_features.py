...
def test_add_new_student_with_dob_and_enrollment(mocker):
    ...
    mock_get_all_classes = mocker.patch('app.tools.database_write_tools.data_service.get_all_classes')
    ...
    mock_get_all_classes.assert_called()
...
def test_add_new_student_invalid_date(mocker):
